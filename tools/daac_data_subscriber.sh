...
python $BASE_PATH/daac_data_subscriber.py -c HLSS30 -s "opera-dev-isl-fwd-mplotkin" --extensions ".tif" -sd 2021-09-07T16:39:00Z -ed 2021-09-07T16:40:00Z > daac_data_subscriber.log 2>&1
STATUS=$?
