...
class TestCCSLCDeletionUtility(unittest.TestCase):
        ...
        with patch('tools.ccslc_deletion_utility.SettingsConf') as mock_settings:
            ...
            with patch('tools.ccslc_deletion_utility.localize_disp_frame_burst_hist') as mock_hist:
                mock_hist.return_value = (
                    ...
                    {'T175-374393-IW1': [10859], 'T175-374394-IW1': [10860]},  # burst_to_frames
    ...
    def test_get_ccslc_objects_by_frame(self, mock_s3_client):
        """Test getting CCSLC objects by frame ID."""
        # Mock S3 response
    ...
    @patch('tools.ccslc_deletion_utility.CCSLCDeletionUtility.s3_client')
    def test_get_ccslc_objects_by_date_range(self, mock_s3_client):
    ...
    @patch('tools.ccslc_deletion_utility.CCSLCDeletionUtility.s3_client')
    def test_get_ccslc_objects_by_burst_id(self, mock_s3_client):
        """Test getting CCSLC objects by burst ID."""
        # Mock S3 response
        mock_s3_client.get_paginator.return_value.paginate.return_value = [
            {
                'Contents': [
    ...
    @patch('tools.ccslc_deletion_utility.CCSLCDeletionUtility.s3_client')
    def test_get_ccslc_objects_by_granule_ids(self, mock_s3_client):
        ...
        granule_ids = ["OPERA_L2_COMPRESSED-CSLC-S1_F10859_T175-374393-IW1_20230101T000000Z_20230101T000000Z_20230131T000000Z_20230201T120000Z_VV_v1.0"]
    ...
    @patch('tools.ccslc_deletion_utility.CCSLCDeletionUtility.s3_client')
    def test_get_ccslc_objects_by_granule_ids_not_found(self, mock_s3_client):
    ...
    @patch('tools.ccslc_deletion_utility.CCSLCDeletionUtility.get_ccslc_objects_by_frame')
    ...
    @patch('tools.ccslc_deletion_utility.CCSLCDeletionUtility.get_ccslc_objects_by_date_range')
    ...
    @patch('tools.ccslc_deletion_utility.CCSLCDeletionUtility.get_ccslc_objects_by_burst_id')
    ...
    @patch('tools.ccslc_deletion_utility.CCSLCDeletionUtility.get_ccslc_objects_by_granule_ids')
