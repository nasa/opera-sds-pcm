...
module "common" {
  ...
  data_subscriber_download_timer_trigger_frequency = var.data_subscriber_download_timer_trigger_frequency
  data_subscriber_query_timer_trigger_frequency = var.data_subscriber_query_timer_trigger_frequency
