...
#    ignore_changes = [tags]
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "    --processes 4 \\",
      "    --force \\",
      "    --artifactory_url ${local.pge_artifactory_dev_url}/${var.pge_names}/opera_pge-${var.pge_names} \\",
#      "    --artifactory_url ${local.pge_artifactory_dev_url} \\",
      ...
      "    --processes 4 \\",
      "    --force \\",
      "    --artifactory_url ${local.pge_artifactory_release_url}/${var.pge_names}/opera_pge-${var.pge_names} \\",
