...
echo "python $OPERA_HOME/data_subscriber/daac_data_subscriber.py query -c SENTINEL-1B_SLC $* 2>&1"
python $OPERA_HOME/data_subscriber/daac_data_subscriber.py query -c SENTINEL-1B_SLC $* > run_slcs1b_query.log 2>&1
