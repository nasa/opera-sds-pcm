...
echo "python $OPERA_HOME/data_subscriber/daac_data_subscriber.py query -c HLSS30 $*"
python $OPERA_HOME/data_subscriber/daac_data_subscriber.py query -c HLSS30 $* > run_hlss30_query.log 2>&1
