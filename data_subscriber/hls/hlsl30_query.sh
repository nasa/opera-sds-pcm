...
echo "python $OPERA_HOME/data_subscriber/daac_data_subscriber.py query -c HLSL30 $*"
python $OPERA_HOME/data_subscriber/daac_data_subscriber.py query -c HLSL30 $* > run_hlsl30_query.log 2>&1
