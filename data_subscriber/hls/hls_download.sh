...
echo "python $OPERA_HOME/data_subscriber/daac_data_subscriber.py download > hls_download.log $* 2>&1"
python $OPERA_HOME/data_subscriber/daac_data_subscriber.py download $* > hls_download.log 2>&1
